<?php
class ManagerCategory extends ModelCategory{
    //METHODES
    ...
    //Param : void
    //Return : array | string
    function readCategories():array | string{
        //1) Création de l'objet de connexion PDO
        $bdd = new PDO('mysql:host=localhost;dbname=task5','root','root',array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
    ...
    //Param : string
    //Return : array | string
    function readCategoryByName():array | string{
        //1) Création de l'objet de connexion PDO
        $bdd = new PDO('mysql:host=localhost;dbname=task5','root','root',array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));

        //Récupération du nom de la Catégorie depuis mon objet
        $name_categorie = $this->getNameCategory();
